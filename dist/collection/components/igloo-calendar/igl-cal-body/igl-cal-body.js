...
export class IglCalBody {
  ...
  addNewEvent(roomCategory) {
    ...
    if (this.selectedRooms[keys[0]].currentDate <
    ...
    let popupTitle = roomCategory.name +
      " " +
      this.getRoomName(this.getRoomById(this.getCategoryRooms(roomCategory), this.selectedRooms[keys[0]].roomId));
  ...
  clickCell(roomId, selectedDay, roomCategory) {
    if (!this.isScrollViewDragging &&
      ...
      else if (Object.keys(this.selectedRooms).length != 1 ||
  ...
  getGeneralRoomDayColumns(roomId, roomCategory) {
    ...
    return this.calendarData.days.map((dayInfo) => (h("div", { class: `cellData pl-0 ${"room_" + roomId + "_" + dayInfo.day} ${dayInfo.day === this.today ? "currentDay" : ""} ${this.dragOverElement === roomId + "_" + dayInfo.day
        ? "dragOverHighlight"
        : ""} ${this.selectedRooms.hasOwnProperty(this.getSelectedCellRefName(roomId, dayInfo))
        ? "selectedDay"
  ...
  getRoomsByCategory(roomCategory) {
    ...
    return (_a = this.getCategoryRooms(roomCategory)) === null || _a === void 0 ? void 0 : _a.map((room) => (h("div", { class: "roomRow" }, h("div", { class: `cellData text-left align-items-center roomHeaderCell roomTitle ${this.getTotalPhysicalRooms(roomCategory) <= 1 ? "pl10" : ""} ${"room_" + this.getRoomId(room)}`, "data-room": this.getRoomId(room) }, h("div", null, this.getTotalPhysicalRooms(roomCategory) <= 1
      ...
      : this.getRoomName(room))), this.getGeneralRoomDayColumns(this.getRoomId(room), roomCategory))));
  }
  getRoomRows() {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: "bodyContainer" }, this.getRoomRows(), h("div", { class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map((bookingEvent) => (h("igl-booking-event", { countryNodeList: this.countryNodeList, currency: this.currency, "data-component-id": bookingEvent.ID, bookingEvent: bookingEvent, allBookingEvents: this.getBookingData() })))))));
  }
