...
export class IglCalHeader {
  ...
  render() {
    return (h(Host, null, h("div", { class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { class: "row justify-content-around no-gutters" }, h("div", { class: "caledarBtns", onClick: () => this.handleOptionEvent("showAssigned"), "data-toggle": "tooltip", "data-placement": "bottom", "data-original-title": "Assignments" }, h("i", { class: "la la-tasks" })), h("div", { class: "caledarBtns", onClick: () => this.handleOptionEvent("calendar"), "data-toggle": "tooltip", "data-placement": "bottom", "data-original-title": "Navigate" }, h("i", { class: "la la-calendar-o" }), h("input", { class: "datePickerHidden", type: "date", onChange: this.handleDateSelect.bind(this) })), h("div", { class: "caledarBtns", onClick: () => this.handleOptionEvent("gotoToday"), "data-toggle": "tooltip", "data-placement": "bottom", "data-original-title": "Today" }, h("i", { class: "la la-clock-o" })), h("div", { class: "caledarBtns", onClick: () => this.handleOptionEvent("add", this.getNewBookingModel()), "data-toggle": "tooltip", "data-placement": "bottom", "data-original-title": "Create new booking" }, h("i", { class: "la la-plus" }))), h("div", { class: "row justify-content-around no-gutters searchContiner" }, h("fieldset", { class: `form-group position-relative ${this.searchValue != "" ? "show" : ""}` }, h("input", { type: "text", class: "form-control form-control-sm input-sm", id: "iconLeft7", value: this.searchValue, placeholder: "Find unit", onInput: (event) => this.handleFilterRooms(event) }), this.searchValue !== "" ? (h("div", { class: "form-control-position pointer", onClick: () => this.handleClearSearch(), "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Clear Selection" }, h("i", { class: "la la-close font-small-4" }))) : null, this.searchList.length ? (h("div", { class: "position-absolute1 searchListContainer1 full-width dropdown-menu dropdown-menu-right full-width" }, this.searchList.map((room) => (h("div", { class: "searchListItem1 dropdown-item p-1 text-left pointer", onClick: () => this.handleScrollToRoom(room.id) }, room.name))))) : null))), h("div", { class: "stickyCell headersContainer" }, h("div", { class: "monthsContainer" }, this.calendarData.monthsInfo.map((monthInfo) => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 70 + "px" } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map((dayInfo) => (h("div", { class: `headerCell align-items-center ${"day-" + dayInfo.day} ${dayInfo.day === this.today ? "currentDay" : ""}`, "data-day": dayInfo.day }, h("div", { class: "preventPageScroll" }, h("span", { class: `badge badge-${dayInfo.unassigned_units_nbr !== 0
        ? "info pointer"
        : "light"} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, dayInfo.unassigned_units_nbr)), h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
  }
