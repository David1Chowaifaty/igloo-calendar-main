...
const IrGeneralSettings = class {
  constructor(hostRef) {
    ...
    this.sendToParent = index.createEvent(this, "sendToParent", 7);
    this.connectionOff = index.createEvent(this, "connectionOff", 7);
  ...
  render() {
    return [
      index.h("div", { class: "General Settings font-size-small" }, index.h("div", { class: "container-fluid" }, this.mode == 'edit' && index.h("div", { class: "text-light border-bottom-light mb-2" }, `ID ${this.data.id}`), index.h("div", { class: "column" }, index.h("ir-select", { class: "channel-select", label: "Channel", data: this.allowed_channels, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", textSize: "sm", labelWidth: 4, selectedValue: this.data !== null ? this.data.channel : null }), index.h("ir-input-text", { id: "title-input", label: "Title", placeholder: "Title", value: this.data !== null ? this.data.title : null, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", labelWidth: 4 }), index.h("ir-select", { id: "property-select", label: "Propery",
        // placeholder="Propery"
      ...
      index.h("ir-modal", { class: "alertFields", modalTitle: "Please fill all the fields!", modalBody: "There are fields that are not filled yet.", iconAvailable: true, icon: "ft-alert-circle warning h1", leftBtnActive: false, btnPosition: "center", rightBtnText: "Close", rightBtnColor: "primary" }),
    ];
  }
...
const IrListItem = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.sendDelete = index.createEvent(this, "sendDelete", 7);
    this.openSidebar = index.createEvent(this, "openSidebar", 7);
    this.createNew = index.createEvent(this, "createNew", 7);
    this.changeStatus = index.createEvent(this, "changeStatus", 7);
    this.type = '';
    this.dropdownData = {
      name: 'Action',
      icon: '',
  ...
  // }
  _renderEmptyState() {
    return (index.h("div", { class: "cardBody" }, index.h("div", { class: "emptyBody" }, index.h("img", { src: emptyState, alt: "empty", class: "img-fluid emptyImg" }), index.h("p", { class: "font-size-small" }, "You don't have any channels yet.", index.h("br", null), "It's a good time to create", index.h("a", { class: "text-primary openSidebar", onClick: () => this.createNew.emit({ mode: 'create', item: null }) }, ' ', "new")))));
  }
  _renderItem() {
    return (index.h("div", null, index.h("div", { class: "container-fluid" }, this.listData.map(item => {
      return (index.h("div", { class: "row" }, index.h("div", { class: "col-12 item-info" }, index.h("div", { class: "row" }, index.h("div", { class: "col-3 p-1" }, item.title), index.h("div", { class: "col-3 p-1" }, item.channel), index.h("div", { class: "col-3 p-1" }, item.status), index.h("div", { class: "col-3 " }, index.h("ir-dropdown", { class: `dropdown-action-${item.id}`, data: item.status === 'Active' ? this.dropdownData : this.dropdownDataDisable, object: item }))))));
    }))));
  }
  _confirmDelete() {
    return (index.h("div", { class: "row" }, index.h("div", { class: "col-2 d-flex justify-content-center align-items-center" }, index.h("ir-icon", { icon: "ft-trash danger h1" })), index.h("div", { class: "col-10" }, index.h("div", { class: "font-weight-bold" }, "Are you sure you want to delete?"), index.h("br", null), index.h("div", { class: "font-size-small" }, "What you delete here will be permanently deleted."))));
  }
  _enable_disable() {
    return (index.h("div", { class: "row" }, index.h("div", { class: "col-2 d-flex justify-content-center align-items-center" }, index.h("ir-icon", { icon: "ft-alert-circle warning h1" })), index.h("div", { class: "col-10" }, index.h("div", { class: "font-weight-bold" }, "Would you like to ", this.type, " this channel?"), index.h("br", null))));
  }
  render() {
    return [
      this.listData !== null && this.listData.length > 0 ? this._renderItem() : this._renderEmptyState(),
      index.h("ir-modal", { modalTitle: this.type === 'delete' ? 'Are you sure you want to delete?' : `Would you like to ${this.type} this channel?`, modalBody: this.type === 'delete' ? 'What you delete here will be permanently deleted.' : `This channel will be ${this.type}d.`, icon: "ft-trash warning h1", iconAvailable: true }),
    ];
  }
};
...
const IrLoader = class {
  ...
  render() {
    return (index.h("div", { class: `lds-default ${this.size}` }, index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null)));
  }
};
...
const IrMapping = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.sendMappingToParent = index.createEvent(this, "sendMappingToParent", 7);
  ...
  render() {
    return [
      index.h("div", { class: "Mapping font-size-small" }, index.h("div", { class: "d-flex justify-content-end align-items-center" }, index.h("a", { class: "text-primary" }, "Refresh")), index.h("div", { class: "container-fluid" }, index.h("div", { class: "row" }, index.h("div", { class: "col-12 mb-1" }, index.h("div", { class: "row " }, index.h("div", { class: "col-6 d-flex justify-content-between align-items-center font-weight-bold" }, "Iglooroom", index.h("ir-icon", { icon: "la la-long-arrow-right" })), index.h("div", { class: "col-6 font-weight-bold" }, "Channel Manager"))), this.hostRoom.map((room, index$1) => {
        return (index.h("div", { class: "col-12 mb-1" }, index.h("div", { class: "row mb-1" }, index.h("div", { class: "col-6 d-flex justify-content-between align-items-center" }, room.name, index.h("ir-icon", { icon: "la la-long-arrow-right" })), index.h("div", { class: `col-6 ` }, room.mapped === 'notMapped' ? (index.h("div", { class: "text-danger", onClick: () => {
            this.hostRoom = [
              ...this.hostRoom.slice(0, index$1),
              Object.assign(Object.assign({}, room), { value: '', mapped: 'mapping', mappedName: '', mappedId: '' }),
              ...this.hostRoom.slice(index$1 + 1),
            ];
          } }, "Not mapped")) : room.mapped === 'mapping' ? (index.h("select", { id: `${index$1}`, class: "form-control form-control-sm", onChange: (event) => {
            let value = JSON.parse(event.target.value);
            this._onSelectMap(room, value, index$1);
          } }, index.h("option", { value: "" }, "Select Room"), this.mapReference.length > 0 &&
          this.mapReference.map(ref => {
            return index.h("option", { value: JSON.stringify(ref) }, ref.name);
          }))) : (index.h("div", { class: "d-flex flex-grow-1 justify-content-between" }, index.h("div", { class: "text-primary" }, room.mappedName, index.h("ir-icon", { icon: "ft-user" }), " ", room.roomCapacity), index.h("ir-icon", { icon: "text-primary ft-trash", onClick: () => {
            this._deselectRoom(room, index$1);
          } }))))), index.h("div", { class: "col-12 mb-1" }, room.ratePlans &&
          room.ratePlans.length &&
          room.ratePlans.map((ratePlan, _index) => (index.h("div", { class: "row mb-1" }, index.h("div", { class: "col-6 d-flex justify-content-between align-items-center" }, index.h("div", null, ratePlan.name, index.h("ir-icon", { icon: "ft-user" }), " ", room.roomCapacity), room.mapped === 'mapped' && index.h("ir-icon", { icon: "la la-long-arrow-right" })), index.h("div", { class: "col-6 pr-0" }, room.mapped === 'mapped' &&
            (ratePlan.mapped === 'notMapped' ? (index.h("div", { class: "text-danger", onClick: () => {
              ...
              } }, "Not mapped")) : ratePlan.mapped === 'mapping' ? (index.h("select", { class: "form-control form-control-sm", onChange: (event) => {
                // mapped.selectedPlan = event.target.value;
                let value = JSON.parse(event.target.value);
                this._onSelectRatePlan(ratePlan, _index, value, room, index$1);
              } }, index.h("option", { value: "" }, "Select Plan"), room.value.ratePlans.length > 0 ? room.value.ratePlans.map(ratePlan => index.h("option", { value: JSON.stringify(ratePlan) }, ratePlan.name)) : null)) : (index.h("div", { class: "d-flex flex-grow-1 justify-content-between" }, index.h("div", { class: "text-primary" }, ratePlan.mappedName, index.h("ir-icon", { icon: "ft-user" }), " ", room.roomCapacity), index.h("ir-icon", { icon: "text-primary ft-trash", onClick: () => {
                this._deselectRatePlan(ratePlan, _index, room, index$1);
              } })))))))))));
      })))),
    ];
  }
...
const IrChannelManager = class {
  ...
  render() {
    return (index.h("div", { class: "card-head" }, index.h("div", { class: "input-group input-group-sm" }, index.h("input", { type: "text", class: "form-control border-light", placeholder: "Search" }), index.h("div", { class: "input-group-append" }), index.h("button", { class: "ml-1 btn btn-primary btn-sm openSidebar", onClick: () => this.handleCreate() }, "Create")), index.h("div", { class: "container-fluid" }, index.h("div", { class: "row" }, index.h("div", { class: "col-3 p-1 section-title" }, "Title ", index.h("ir-icon", { icon: "la la-unsorted" })), index.h("div", { class: "col-3 p-1 section-title" }, "Channel ", index.h("ir-icon", { icon: "la la-unsorted" })), index.h("div", { class: "col-3 p-1 section-title" }, "Status ", index.h("ir-icon", { icon: "la la-unsorted" }))))));
  }
};

exports.ir_general_settings = IrGeneralSettings;
exports.ir_list_item = IrListItem;
exports.ir_loader = IrLoader;
exports.ir_mapping = IrMapping;
exports.ir_topbar = IrChannelManager;

//# sourceMappingURL=ir-general-settings_5.cjs.entry.js.map