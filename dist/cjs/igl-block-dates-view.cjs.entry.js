...
const IglBlockDatesView = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: `m-0 p-0 mb-1` }, index.h("div", { class: "text-left p-0" }, index.h("span", { class: "pr-1" }, index.h("span", { class: "text-bold-700 font-medium-1" }, axios.locales.entries.Lcz_From, ": "), utils.formatDate(this.fromDate)), index.h("span", { class: "text-bold-700 font-medium-1" }, axios.locales.entries.Lcz_To, ": "), utils.formatDate(this.toDate))), index.h("div", { class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { class: "mb-1 " }, index.h("label", { class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, axios.locales.entries.Lcz_Reason, ":"), index.h("div", { class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { class: "align-middle out-of-service-label" }, axios.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, axios.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: axios.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, axios.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: this.blockDatesData.RELEASE_AFTER_HOURS == +releaseItem.CODE_NAME }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, axios.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
  }
};
