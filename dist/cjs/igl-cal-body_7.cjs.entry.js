...
const IglCalBody = class {
  ...
  addNewEvent(roomCategory) {
    ...
    this.newEvent = {
      ...
      RATE_PLAN: '',
      ARRIVAL_TIME: '',
      TITLE: axios.locales.entries.Lcz_NewBookingFor,
    ...
    this.newEvent.BLOCK_DATES_TITLE = axios.locales.entries.Lcz_BlockDatesFor + popupTitle;
  ...
  getRoomCategoryRow(roomCategory, index$1) {
    ...
    return (index.h("div", { class: "roomRow" }, index.h("div", { class: `cellData text-left align-items-center roomHeaderCell categoryTitle ${'category_' + this.getCategoryId(roomCategory)}`, onClick: () => this.toggleCategory(roomCategory) }, index.h("div", { class: 'categoryName' }, this.getCategoryName(roomCategory)), roomCategory.expanded ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 14, width: 14 }, index.h("path", { fill: "#6b6f82", d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512", height: 14, width: 14 }, index.h("path", { fill: "#6b6f82", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), this.getGeneralCategoryDayColumns('category_' + this.getCategoryId(roomCategory), true, index$1)));
  }
...
const IglCalFooter = class {
  ...
  render() {
    return (index.h(index.Host, { class: "footerContainer" }, index.h("div", { class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { class: "la la-square" }), index.h("u", null, axios.locales.entries.Lcz_Legend))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
  }
};
...
const IglLegends = class {
  ...
  render() {
    return (index.h(index.Host, { class: "legendContainer pr-1 text-left" }, index.h("div", { class: 'w-full' }, index.h("div", { class: 'w-full' }, index.h("div", { class: "stickyHeader pt-1 " }, index.h("p", { class: "legendHeader" }, axios.locales.entries.Lcz_Legend), index.h("div", { class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", null)), index.h("div", { class: "mt-2 pl-1" }, this.legendData.map(legendInfo => (index.h("div", { class: "legendRow " }, index.h("div", { class: `legend_${legendInfo.design} mr-1`, style: { backgroundColor: legendInfo.color } }), index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("hr", null), index.h("div", { class: "mt-2" }, index.h("div", { class: "legendCalendar" }, index.h("div", { class: "legendRow align-items-center" }, index.h("div", { class: "legendCal br-t br-s br-bt" }, index.h("strong", null, "MAR 2022")), index.h("div", { class: "highphenLegend" }, axios.locales.entries.Lcz_MonthAndYear)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal headerCell align-items-center br-s" }, index.h("span", { class: "badge badge-info  badge-pill" }, "3")), index.h("div", { class: "highphenLegend" }, index.h("div", null, axios.locales.entries.Lcz_UnassignedUnits))), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { class: "highphenLegend" }, axios.locales.entries.Lcz_Date)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { class: "highphenLegend" }, axios.locales.entries.Lcz_Occupancy)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { class: "highphenLegend" }, axios.locales.entries.Lcz_TotalAvailability))))))));
  }
};
...
const IglToBeAssigned = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, { class: "tobeAssignedContainer pr-1 text-left" }, index.h("div", null, index.h("div", null, index.h("div", { class: "stickyHeader pt-1" }, index.h("p", { class: "tobeAssignedHeader " }, axios.locales.entries.Lcz_Assignments), index.h("ir-icon", { class: "closeBtn pt-2", onIconClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", null), Object.keys(this.data).length === 0 ? (index.h("p", null, axios.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("p", null, this.loadingMessage)) : (index.h(index.Fragment, null, this.orderedDatesList.length ? (index.h("div", { class: `custom-dropdown border border-light rounded text-center ` + (this.showDatesList ? 'show' : ''), id: "dropdownMenuButton", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, index.h("div", { class: 'dropdown-toggle' }, index.h("span", { class: "font-weight-bold" }, this.data[this.selectedDate].dateStr), index.h("svg", { class: 'caret-icon', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 14, width: 14 }, index.h("path", { fill: "#6b6f82", d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("div", { class: "dropdown-menu dropdown-menu-right full-width", "aria-labelledby": "dropdownMenuButton" }, (_a = this.orderedDatesList) === null || _a === void 0 ? void 0 : _a.map(ordDate => (index.h("div", { class: "dropdown-item pointer", onClick: () => this.showForDate(ordDate) }, this.data[ordDate].dateStr)))))) : (axios.locales.entries.Lcz_AllBookingsAreAssigned)))), !this.isLoading && (index.h("div", { class: "scrollabledArea" }, this.orderedDatesList.length ? (Object.keys(this.data[this.selectedDate].categories).length ? (this.getCategoryView()) : (index.h("div", { class: "mt-1" }, axios.locales.entries.Lcz_AllAssignForThisDay))) : null))))));
  }
  static get watchers() { return {
...
const irBookingDetailsCss = ".sc-ir-booking-details-h{overflow-x:hidden}.confirmed.sc-ir-booking-details{color:#fff;display:flex;align-items:center}.bg-ir-green.sc-ir-booking-details{background:#629a4c;height:28px;padding-top:0 !important;padding-bottom:0 !important}.h-28.sc-ir-booking-details{height:2rem}.bg-ir-red.sc-ir-booking-details{background:#ff4961;height:28px;padding-top:0 !important;padding-bottom:0 !important}.bg-ir-orange.sc-ir-booking-details{background:#ff9149;height:28px;padding-top:0 !important;padding-bottom:0 !important}.date-margin.sc-ir-booking-details{margin-right:5px}.pickup-margin.sc-ir-booking-details{margin-bottom:7px !important}.header-date.sc-ir-booking-details{padding-left:5px !important}.pointer.sc-ir-booking-details{cursor:pointer}.sc-ir-booking-details:root{--sidebar-width:50rem}.sm-padding-right.sc-ir-booking-details{padding-right:0.2rem}.sm-padding-left.sc-ir-booking-details{padding-left:0.2rem}.sm-padding-top.sc-ir-booking-details{padding-top:0.2rem}.sm-padding-bottom.sc-ir-booking-details{padding-bottom:0.2rem}.info-notes.sc-ir-booking-details{list-style:none;padding-left:0}.light-blue-bg.sc-ir-booking-details{background-color:#acecff;padding:0rem 0.1rem}.iframeHeight.sc-ir-booking-details{height:17.5rem}";
    ...
    switch (target.id) {
      ...
      case 'room-add':
        this.bookingItem = {
          ...
          TITLE: `${axios.locales.entries.Lcz_AddingUnitToBooking}# ${this.bookingData.booking_nbr}`,
          defaultDateRange: {
    ...
    if (this.tempStatus !== '' && this.tempStatus !== null) {
      try {
        ...
        this.toast.emit({
          type: 'success',
          description: '',
          title: axios.locales.entries.Lcz_StatusUpdatedSuccessfully,
          position: 'top-right',
        });
      ...
      this.toast.emit({
        type: 'error',
        description: '',
        title: axios.locales.entries.Lcz_SelectStatus,
        position: 'top-right',
      });
    }
  }
...
const IrRoomNights = class {
  ...
  renderInputField(index$1, currency_symbol, day) {
    return (index.h("fieldset", { class: "col-2 ml-1 position-relative has-icon-left m-0 p-0 rate-input-container" }, index.h("div", { class: "input-group-prepend" }, index.h("span", { "data-disabled": this.inventory === 0 || this.inventory === null, "data-state": this.isInputFocused === index$1 ? 'focus' : '', class: "input-group-text new-currency", id: "basic-addon1" }, currency_symbol)), index.h("input", { onFocus: () => (this.isInputFocused = index$1), onBlur: () => (this.isInputFocused = -1), disabled: this.inventory === 0 || this.inventory === null, type: "text", class: "form-control pl-0 input-sm rate-input py-0 m-0 rounded-0 rateInputBorder", id: v4.v4(), value: day.amount > 0 ? day.amount : '', placeholder: axios.locales.entries.Lcz_Rate || 'Rate', onInput: event => this.handleInput(event, index$1) })));
  }
  ...
  render() {
    var _a, _b, _c;
    if (!this.bookingEvent) {
      return index.h("p", null, axios.locales.entries.Lcz_Loading);
    }
    return (index.h(index.Host, null, index.h("div", { class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between " }, index.h("h3", { class: "card-title text-left pb-1 font-medium-2 px-2" }, axios.locales.entries.Lcz_AddingRoomNightsTo, " ", (_b = (_a = this.selectedRoom) === null || _a === void 0 ? void 0 : _a.roomtype) === null || _b === void 0 ? void 0 :
      _b.name, " ", ((_c = this.selectedRoom) === null || _c === void 0 ? void 0 : _c.unit).name), index.h("button", { type: "button", class: "close close-icon", onClick: () => this.closeRoomNightsDialog.emit({ type: 'cancel', pool: this.pool }) }, index.h("ir-icon", { icon: "ft-x", class: 'm-0' })))), index.h("section", { class: 'text-left px-2' }, index.h("p", { class: 'font-medium-1' }, `${axios.locales.entries.Lcz_Booking}#`, " ", this.bookingNumber), index.h("p", { class: 'font-weight-bold font-medium-1' }, `${utils.formatDate(this.fromDate, 'YYYY-MM-DD')} - ${utils.formatDate(this.toDate, 'YYYY-MM-DD')}`), this.initialLoading ? (index.h("p", { class: 'mt-2 text-secondary' }, axios.locales.entries['Lcz_CheckingRoomAvailability '])) : (index.h(index.Fragment, null, index.h("p", { class: 'font-medium-1 mb-0' }, `${this.selectedRoom.rateplan.name}`, " ", this.selectedRoom.rateplan.is_non_refundable && index.h("span", { class: 'irfontgreen' }, axios.locales.entries.Lcz_NonRefundable)), (this.inventory === 0 || this.inventory === null) && index.h("p", { class: "font-medium-1 text danger" }, axios.locales.entries.Lcz_NoAvailabilityForAdditionalNights), this.selectedRoom.rateplan.custom_text && index.h("p", { class: 'text-secondary mt-0' }, this.selectedRoom.rateplan.custom_text), this.renderDates()))), index.h("section", { class: 'd-flex align-items-center mt-2 px-2' }, index.h("ir-button", { btn_color: "secondary", btn_disabled: this.isLoading, text: axios.locales === null || axios.locales === void 0 ? void 0 : axios.locales.entries.Lcz_Cancel, class: "full-width", btn_styles: "justify-content-center", onClickHanlder: () => this.closeRoomNightsDialog.emit({ type: 'cancel', pool: this.pool }) }), this.inventory > 0 && this.inventory !== null && (index.h("ir-button", { isLoading: this.isLoading, text: axios.locales === null || axios.locales === void 0 ? void 0 : axios.locales.entries.Lcz_Confirm, btn_disabled: this.isButtonDisabled(), class: "ml-1 full-width", btn_styles: "justify-content-center", onClickHanlder: this.handleRoomConfirmation.bind(this) })))));
  }
};
...
//# sourceMappingURL=igl-cal-body_7.cjs.entry.js.map