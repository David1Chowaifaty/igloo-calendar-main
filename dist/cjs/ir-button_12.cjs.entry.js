...
const IrChannel = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, { class: "bg-white h-100" }, index.h("section", { class: "p-2" }, index.h("div", { class: "d-flex w-100 justify-content-end mb-2" }, index.h("ir-button", { text: 'Create', size: "sm", onClickHanlder: () => (this.channel_status = 'create') })), index.h("div", { class: "table-container" }, index.h("table", { class: "table table-hover" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, "Title"), index.h("th", { scope: "col" }, "Channel"), index.h("th", { scope: "col" }, "Status"), index.h("th", { scope: "col" }, "Actions"))), index.h("tbody", { class: "" }, (_a = channel_store.channels_data.connected_channels) === null || _a === void 0 ? void 0 : _a.map(channel => (index.h("tr", { key: channel.channel.id }, index.h("th", { scope: "row", class: "text-left" }, channel.title), index.h("th", { scope: "row" }, channel.channel.name), index.h("td", null, index.h("ir-switch", { checked: channel.is_active })), index.h("th", null, index.h("div", { class: "btn-group" }, index.h("button", { type: "button", class: "btn  dropdown-toggle", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, index.h("span", { class: "mr-1" }, "Actions"), index.h("svg", { class: 'caret-icon', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 14, width: 14 }, index.h("path", { fill: "var(--blue)", d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("div", { class: "dropdown-menu dropdown-menu-right" }, actions(axios.locales.entries).map((a, index$1) => (index.h(index.Fragment, null, index$1 === actions(axios.locales.entries).length - 1 && index.h("div", { key: a.id + '_divider', class: "dropdown-divider my-0" }), index.h("button", { onClick: () => {
        console.log(a.id);
        a.action(channel);
        if (a.id === 'edit') {
          setTimeout(() => {
      ...
      }, key: a.id + '_item', class: `dropdown-item my-0 ${a.id === 'remove' ? 'danger' : ''}`, type: "button" }, a.icon(), a.name)))))))))))))), index.h("ir-sidebar", { sidebarStyles: {
        width: '60rem',
      ...
      }, open: this.channel_status !== null }, this.channel_status && (index.h("ir-channel-editor", { class: "p-1", channel_status: this.channel_status, onCloseSideBar: () => {
        this.channel_status = null;
        channel_store.resetStore();
