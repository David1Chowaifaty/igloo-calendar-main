...
const IrPaymentDetails$1 = /*@__PURE__*/ proxyCustomElement(class IrPaymentDetails extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  components.forEach(tagName => { switch (tagName) {
    case "ir-payment-details":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, IrPaymentDetails$1);
      }
      break;
    case "ir-button":
      if (!customElements.get(tagName)) {
...
const IrPaymentDetails = IrPaymentDetails$1;
const defineCustomElement = defineCustomElement$1;

export { IrPaymentDetails, defineCustomElement };
