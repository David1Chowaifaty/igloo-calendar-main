...
const IrBookingDetails$1 = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return irBookingDetailsCss; }
    ...
    "guestData": [32],
    "rerenderFlag": [32]
  }, [[0, "iconClickHandler", "handleIconClick"], [0, "irSidebarToggle", "handleSidebarToggle"], [0, "editSidebar", "handleEditSidebar"], [0, "submitForm", "handleFormSubmit"], [0, "selectChange", "handleSelectChange"], [0, "clickHanlder", "handleClick"]], {
    "ticket": ["ticketChanged"],
    "dropdownStatuses": ["watchDropdownStatuses"]
  }]);
  ...
  components.forEach(tagName => { switch (tagName) {
    case "ir-booking-details":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, IrBookingDetails$1);
      }
      break;
    case "ir-button":
      if (!customElements.get(tagName)) {
